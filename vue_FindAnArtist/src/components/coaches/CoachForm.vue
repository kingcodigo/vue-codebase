<template>
  <form @submit.prevent="submitForm" :class="{ invalid: !firstName.isValid }">
    ...
    <div class="form-control" :class="{ invalid: !areas.isValid }">
      ...
      @blur="clearValidity('areas')" />
      <label for="frontend">Backend Development</label><br />
      <input type="checkbox" id="career" value="career" v-model="areas.val"
      @blur="clearValidity('areas')" />
      <label for="frontend">Career Advisory</label><br /><br />
      <p v-if="!areas.isValid">At least one has to be selected</p>
